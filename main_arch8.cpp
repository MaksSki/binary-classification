...
int main() {
    ...
    // Define Architecture 2: (2, 8, 8, 1)
    std::vector<std::pair<unsigned, ActivationFunction*>> layers_config_arch8 = {
    ...
    run_architecture(
        ...
        "cost_log_8.dat",          // Unique cost log filename
        "grid_output_8.dat"        // Unique grid output filename
    );
