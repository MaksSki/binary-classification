...
int main() {
    ...
    // Define Architecture 1: (2, 4, 4, 1)
    std::vector<std::pair<unsigned, ActivationFunction*>> layers_config_arch4 = {
    ...
    run_architecture(
        ...
        "cost_log_4.dat",          // Unique cost log filename
        "grid_output_4.dat"        // Unique grid output filename
    );
